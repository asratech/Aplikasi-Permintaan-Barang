   				...
   				<div class="box-body">
   					<form action="<?php echo base_url('admin/man_user'); ?>" method="post">
   						...
   						<div class="form-group">
   							...
   							<input type="text" class="form-control form-control-sm" style="text-transform:uppercase" name="nama" required>
   						</div>
   								<div class="form-group">
   									<label for="level">Cabang</label>
   									<select class="form-control form-control-sm" name="idcabang" required>
   										<option value="">- Pilih Cabang -</option>
   										<?php foreach ($cabang as $d) : ?>
   											<option value="<?php echo $d['idcabang']; ?>"><?php echo $d['namacabang']; ?></option>
   										<?php endforeach; ?>
   									</select>
   								</div>
   						<div class="row">
   							<div class="col-md-6">
   								<div class="form-group">
   									...
   									<select class="form-control form-control-sm" name="divisi_kode" required>
   							...
   							<div class="col-md-6">
   								<div class="form-group">
   									<label>No HP</label>
   									<input type="number" class="form-control form-control-sm" maxleght="12" name="hp" required>
   								</div>
   							</div>
   						</div>
   						<div class="form-group">
   					...
   					<form action="<?php echo base_url('admin/proses_edit_user'); ?>" method="post" id="form_id">
   						...
   						<div class="row">
   							...
   							<div class="col-md-6">
   								<div class="form-group">
   									<label for="level">Divisi</label>
   									<select class="form-control form-control-sm" name="divisi_kode" id="divisi_kode" required>
   										<option value="">- Pilih Divisi -</option>
   										<?php foreach ($divisi as $d) : ?>
   											<option value="<?php echo $d['kode_divisi']; ?>"><?php echo $d['nama_divisi']; ?></option>
   										<?php endforeach; ?>
   						...
   						<div class="form-group">
   							<label>Nama Lengkap</label>
   							<input type="text" class="form-control form-control-sm" style="text-transform:uppercase" name="nama" id="nama" required>
   						</div>
   						<div class="form-group">
   							<label>No HP</label>
   							<input type="number" class="form-control form-control-sm" maxlength="12" name="hp" id="hp" required>
   						</div>
   						<div class="form-group">
   							<label>Email</label>
